        ...
        <div class="l-card__container">
          ...
          <div class="c-form__container__profile">
            <div class="c-form__item">
              <label for class="c-form-lavel c-form-lavel__profile"
                >プロフィール画像</label
              >
              <label class="c-input__profile">
                ...
                <output v-if="preview">
                  <img
                    v-bind:src="profileData.profileImage"
                    alt="プロフィール画像"
              ...
              <!-- バリデーションエラー --->
              <div v-if="profileErrorMessages" class="c-error errors__profile">
              ...
              >
                ...
                <div class="u-btn__common__margin">
                  <button class="c-btn c-btn__common" @click="profileImageEdit">
                    変更
                  </button>
                </div>
              </div>
            ...
            <div class="u-profile__form">
              <div class="c-form__item">
                ...
                <div v-if="profileErrorMessages" class="c-error">
                  <ul v-if="profileErrorMessages.name">
                    <li v-for="msg in profileErrorMessages.name" :key="msg">
                      {{ msg }}
                    </li>
                  </ul>
                </div>
                <!-- 変更用ボタン -->
                <div class="l-flex u-btn__wrapp" v-show="showName">
                  <div class="u-btn__common__margin">
                    <button
                      class="c-btn c-btn__common c-btn__common__cancel"
                      @click="cancelName"
              ...
              <div class="c-form__item">
                ...
                <div v-if="profileErrorMessages" class="c-error">
                  <ul v-if="profileErrorMessages.email">
                    <li v-for="msg in profileErrorMessages.email" :key="msg">
                      {{ msg }}
                    </li>
                  </ul>
                </div>
              ...
              <div class="l-flex u-btn__wrapp" v-show="showEmail">
                ...
                <div class="u-btn__common__margin">
                  <button class="c-btn c-btn__common" @click="profileEmailEdit">
                    変更
                  </button>
                </div>
              </div>
              ...
              <div class="u-btn__wrapp u-btn__password">
                <button class="c-btn c-btn__common" @click="openPasswordModal">
                  パスワードの変更
                </button>
              </div>
            </div>
      ...
      axios
        ...
        .then((response) => {
          ...
          if (response.data.pic !== null) {
            this.profileData.profileImage = response.data.pic;
            this.preview = true;
          }
