        ...
        <nav class="sp-menu" :class="spMenuItem">
            <ul class="l-header__nav--list" v-if="isLogin">
                <li class="l-header__menu--item">
                    <router-link to="/index" class="c-btn c-header__btn"
                        >TOP</router-link
                    >
                </li>
                <li class="l-header__menu--item">
                    <router-link to="/tasklist" class="c-btn c-header__btn"
                        >タスク管理ページ</router-link
                    >
                </li>
                <li class="l-header__menu--item">
                    <router-link to="/profile" class="c-btn c-header__btn"
                        >プロフィール編集</router-link
                    >
                </li>
                <li class="l-header__menu--item">
                    <span @click="logout" class="c-btn c-header__btn"
                        >ログアウト</span
                    >
                </li>
            </ul>
            <ul class="l-header__nav--list" v-else>
                ...
                <li class="l-header__menu--item">
                    <router-link to="register" class="c-btn c-header__btn"
                        >新規登録</router-link
                    >
                </li>
                <li class="l-header__menu--item">
                    <router-link to="login" class="c-btn c-header__btn"
                        >ログイン</router-link
                    >
                </li>
            </ul>
